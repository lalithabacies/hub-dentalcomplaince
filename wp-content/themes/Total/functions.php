...
define( 'WPEX_THEME_VERSION', '3.5.0' );
...
class WPEX_Theme_Setup {
	...
	public function __construct() {
		...
		/** Non Admin actions **/
			...
			add_filter( 'embed_oembed_html', array( 'WPEX_Theme_Setup', 'add_responsive_wrap_to_oembeds' ), 99, 4 );
	...
	public static function theme_js() {
		...
		// Load all non-minified js
			...
			// Slider Pro
			wp_enqueue_script( 'wpex-sliderpro', $dir .'core/jquery.sliderPro.js', array( 'jquery' ), '1.2.5', true );
			wp_enqueue_script( 'wpex-sliderpro-customthumbnails', $dir .'core/jquery.sliderProCustomThumbnails.js', array( 'jquery' ), false, true );
			...
			// Used for milestones
			wp_enqueue_script( 'wpex-count-to', $dir .'core/count-to.js', array( 'jquery' ), $theme_version, true );
	...
	public static function localize_array() {
		...
		$array = array(
			...
			//'superfishAnimation'     => 'opacity', @todo Add option to alter animation on dropdown
