...
class WPEX_Post_Metaboxes {
					...
					foreach ( $tab['settings'] as $setting ) {
						...
						<tr<?php if ( $hidden ) echo ' style="display:none;"'; ?> id="<?php echo esc_attr( $meta_id ); ?>_tr">
							...
							elseif ( 'number' == $type ) { ?>
								...
								<td><input name="<?php echo esc_attr( $meta_id ); ?>" type="number" value="<?php echo esc_attr( $meta_value ); ?>"></td>
	...
	public static function metaboxes_js() {
		...
		<script type="text/javascript">
			!function(e){"use strict";e(document).on("ready",function(){var t=e(".wpex-date-meta");t.length&&e.datepicker&&t.datepicker({dateFormat:"<?php echo esc_html( $date_format ); ?>"}),e("div#wpex-metabox ul.wp-tab-bar a").click(function(){var t=e("#wpex-metabox ul.wp-tab-bar li"),a=e(this).data("tab"),o=e("#wpex-metabox div.wp-tab-panel");return e(t).removeClass("wp-tab-active"),e(o).hide(),e(a).show(),e(this).parent("li").addClass("wp-tab-active"),!1}),e("div#wpex-metabox .wpex-mb-color-field").wpColorPicker();var a=!0,o=wp.media.editor.send.attachment;e("div#wpex-metabox .wpex-mb-uploader").click(function(t){var i=(wp.media.editor.send.attachment,e(this)),r=i.prev();return wp.media.editor.send.attachment=function(t,i){return a?void e(r).val(i.id):o.apply(this,[t,i])},wp.media.editor.open(i),!1}),e("div#wpex-metabox .add_media").on("click",function(){a=!1}),e("div#wpex-metabox div.wpex-mb-reset a.wpex-reset-btn").click(function(){var t=e("div.wpex-mb-reset div.wpex-reset-checkbox"),a=t.is(":visible")?"<?php esc_html_e(  'Reset Settings', 'total' ); ?>":"<?php esc_html_e(  'Cancel Reset', 'total' ); ?>";e(this).text(a),e("div.wpex-mb-reset div.wpex-reset-checkbox input").attr("checked",!1),t.toggle()});var i=e("div#wpex-metabox select#wpex_disable_title"),r=e("#wpex_disable_header_margin_tr, #wpex_post_subheading_tr,#wpex_post_title_style_tr"),_=e("div#wpex-metabox select#wpex_post_title_style"),d=_.val(),l=e("#wpex_post_title_background_color_tr, #wpex_post_title_background_redux_tr,#wpex_post_title_height_tr,#wpex_post_title_background_overlay_tr,#wpex_post_title_background_overlay_opacity_tr"),p=e("#wpex_post_title_background_color_tr");"on"===i.val()?(r.hide(),l.hide()):r.show(),"background-image"===d?l.show():"solid-color"===d&&p.show(),i.change(function(){if("on"===e(this).val())r.hide(),l.hide();else{r.show();var t=_.val();"background-image"===t?l.show():"solid-color"===t&&p.show()}}),_.change(function(){l.hide(),"background-image"==e(this).val()?l.show():"solid-color"===e(this).val()&&p.show()});var s=e("div#wpex-metabox select#wpex_overlay_header"),n=e("#wpex_overlay_header_style_tr, #wpex_overlay_header_font_size_tr,#wpex_overlay_header_logo_tr,#wpex_overlay_header_logo_retina_tr,#wpex_overlay_header_logo_retina_height_tr,#wpex_overlay_header_dropdown_style_tr");"on"===s.val()?n.show():n.hide(),s.change(function(){"on"===e(this).val()?n.show():n.hide()})})}(jQuery);
		</script>
