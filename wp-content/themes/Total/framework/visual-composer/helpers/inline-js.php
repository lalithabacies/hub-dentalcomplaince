...
class VCEX_Inline_JS {
	...
	private function typed_text() { ?>
		void 0!=$.fn.typed&&$(".vcex-typed-text").each(function(){var e=$(this),t=e.data("settings");t.typeSpeed=parseInt(t.typeSpeed),t.backDelay=parseInt(t.backDelay),t.strings=e.data("strings"),e.typed(t)});
	<?php }
