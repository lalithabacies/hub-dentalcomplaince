		...
		<div class="settingcolumnwrap">
			...
			<div id="accordion_advance" class="package_advance">
				...
				<div class="advance-input">
					...
					<label class="input-check">Open Link in New Tab:
					<input type="checkbox" name="new_tab" class="tickbox" id="new_tab" value="yes" /></label>
				</div>
				<h3 class="ptitle">Structural Settings</h3>
				<div class="advance-input">
					...
					<label class="input-title">Title Body Height</label>
					<input type="text" name="title_body" class="medium" id="title_body" value="" placeholder="e.g. 48px" />
					<label class="input-title">Price Body Height</label>
					<input type="text" name="price_body" class="medium" id="price_body" value="" placeholder="e.g. 120px" />
					<label class="input-title">Feature Label Body Height</label>
					<input type="text" name="feature_body" class="medium" id="feature_body" value="" placeholder="e.g. 42px" />
					<label class="input-title">Tooltip Width</label>
					<input type="text" name="tooltip_width" class="medium" id="tooltip_width" value="" placeholder="e.g. 130px" />
					<label class="input-title">Feature Label Font Direction:</label>
				...
				<div class="advance-input">
					...
					<label class="input-title">Feature Values Font Size</label>
