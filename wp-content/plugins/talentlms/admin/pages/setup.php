<div class="wrap">
	<h2><i class="fa fa-cog"></i>&nbsp;<?php _e('Setup', 'talentlms'); ?></h2>
    ...
    <form name="talentlms-api-form" method="post" action="<?php echo admin_url('admin.php?page=talentlms-setup'); ?>">
        ...
        <table class="form-table">
            <tr>
                <th scope="row" class="form-field form-required <?php echo $domain_validation; ?>">
                    <label for="tl-domain"><?php _e("TalentLMS Domain", 'talentlms'); ?> <span class="description"><?php _e("(Required)", 'talentlms'); ?></span>:</label>
                </th>
            ...
            <tr>                
                <th scope="row" class="form-field form-required <?php echo $api_validation; ?>">
                    <label for="tl-api-key"><?php _e("API Key", 'talentlms'); ?> <span class="description"><?php _e("(Required)", 'talentlms'); ?></span>:</label>
                </th>
        ...
        <p class="submit">
            ...
            &nbsp;<span class="description"><?php _e("Submitting any changes will force the cached/synced content to be cleared", 'talentlms'); ?></span>
        </p>        
    </form>
