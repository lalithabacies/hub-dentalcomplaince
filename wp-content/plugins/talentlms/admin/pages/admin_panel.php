			...
			<div class="tl-admin-options-grid">
				...
				<a href="<?php echo admin_url('admin.php?page=talentlms-options'); ?>">
					<div class="tl-admin-option">
						...
						<h3><?php _e('Options', 'talentlms'); ?></h3>
						<p><?php _e('Customize the plugin behavior', 'talentlms'); ?></p>
					</div>
				</a>
                ...
                <a href="<?php echo admin_url('admin.php?page=talentlms-sync'); ?>">
					<div class="tl-admin-option">
						...
						<h3><?php _e('Sync', 'talentlms'); ?></h3>
						<p><?php _e('Synchronize users and content', 'talentlms'); ?></p>
					</div>
				</a>
				...
				<div class="tl-admin-option" data-toggle="modal" data-target="#shortcodesModal">
					...
					<p><?php _e('Widgets to use with your WordPress site', 'talentlms'); ?></p>
				</div>
				</a>
...
<!--     
    <h3><?php //_e('Cache control', 'talentlms'); ?></h3>
        ...
        <table class="form-table">
            <tr>
                <th scope="row" class="form-field" style="width: 30em;">
                    <?php _e('Clearing the cache will force contacting your Talentlms domain', 'talentlms'); ?>
                </th>
                <td class="form-field">
                    <input class="button-secondary" type="submit" name="Clear cache" value="<?php _e('Clear cache', 'talentlms') ?>" style="width: 8.5em;" />
                </td>
            </tr>
        </table>
    </form>
