{if !$ajax_pagination}
<div class="wpc_client_files_blog wpc_filesla_shortcode" data-form_id="{$files_form_id}">
                ...
                <div class="wpc_blogitem_head">
                    <div class="wpc_blogitem_date">
                        ...
                        {if $show_author && $file.author}
                            &nbsp;by&nbsp;
                            <span class="wpc_filedata wpc_file_author_value" data-author_id="{$file.author_id}" title="{$texts.filter_by} {$texts.author}: {$file.author}">{$file.author}</span>
                        {/if}
                        </p>
                    </div>
