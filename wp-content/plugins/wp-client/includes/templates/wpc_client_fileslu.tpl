{if !$ajax_pagination}
<div class="wpc_client_files_list wpc_fileslu_shortcode" data-form_id="{$files_form_id}">
            ...
            <div class="file_item">
                ...
                <div class="wpc_filedata_wrapper">
                    ...
                    <div class="wpc_file_actions">
                        <a href="javascript:void(0);" title="{$file.title} {$texts.details}" class="wpc_file_details_link" data-hide_text="{$texts.hide_details}">{$texts.details}</a>&nbsp;|&nbsp;
                        {if $file.new_page}
