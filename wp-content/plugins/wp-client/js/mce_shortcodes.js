					...
					d = e.createMenuButton( 'wpc_client_button_shortcodes',{
                        ...
                        d.onRenderMenu.add( function( c, b ) {
							...
							c = b.addMenu( {title: 'Shortcodes: Pages'} );
                                ...
                                a.addImmediate( c, 'Invoicing List (Addon)', '[wpc_client_invoicing_list type="invoice|estimate" status="sent|draft|partial|paid|refunded" show_date="yes|no" show_description="yes|no" show_type_payment="yes|no" show_invoicing_amount="yes|no" pay_now_links="yes|no" ]' );
                            ...
                            c = b.addMenu( {title: 'Shortcodes: Others'} );
                                ...
                                a.addImmediate( c, 'Private Content', '[wpc_client_private for="" for_circle="" privacy_type="include|exclude" circle_condition="or|and" ]' );
                                a.addImmediate( c, 'Images URL', '[wpc_client_theme]' );
                                a.addImmediate( c, 'Files Client Have Access To', '[wpc_client_filesla show_tags="yes|no" show_sort="yes|no" sort_type="name|date" sort="asc|desc" categories_sort_type="name|order_id" categories_sort="asc|desc" show_date="yes|no" show_size="yes|no" show_author="yes|no" no_text="" category="" with_subcategories="yes|no" view_type="list|table|tree|blog" show_file_cats="yes|no" show_last_download_date="yes|no" show_thumbnails="yes|no" show_search="yes|no" show_filters="yes|no" show_bulk_actions="yes|no" show_pagination="yes|no" show_pagination_by="5" exclude_author="yes|no" /]' );
                                a.addImmediate( c, 'Files Client Have Uploaded', '[wpc_client_fileslu show_tags="yes|no" show_sort="yes|no" sort_type="name|date" sort="asc|desc" categories_sort_type="name|order_id" categories_sort="asc|desc" show_date="yes|no" show_size="yes|no" show_author="yes|no" no_text="" category="" with_subcategories="yes|no" view_type="list|table|tree|blog" show_file_cats="yes|no" show_last_download_date="yes|no" show_thumbnails="yes|no" show_search="yes|no" show_filters="yes|no" show_bulk_actions="yes|no" show_pagination="yes|no" show_pagination_by="5" /]' );
                                a.addImmediate( c, 'File Upload Form', '[wpc_client_uploadf category="ID" auto_upload="yes|no" exclude="FILE EXTENSIONS HERE (for example: jpg,png,gif)"  include="FILE EXTENSIONS HERE (for example: jpg,png,gif)" ]' );
                                a.addImmediate( c, 'List of Portal Portals', '[wpc_client_pagel view_type="list|tree" categories="IDs|names" show_categories_titles="yes|no" show_date="yes|no" show_current_page="no|yes" show_sort="yes|no" sort_type="date|title|order_id" sort="asc|desc" ]' );
                                ...
                                a.addImmediate( c, 'List of Private Post Type Pages (Addon)', '[wpc_client_private_post_types  private_post_types="" sort_type="date|title" sort="asc|desc" ]' );
                                ...
                                a.addImmediate( c, 'Hub Activity', '[wpc_client_user_activity_alert title="Hub Activity" text_advise="Please advise, you have:" position="bottom right" offset_x="0" offset_y="0" ]' );
						});
					return d
				}
				return null
