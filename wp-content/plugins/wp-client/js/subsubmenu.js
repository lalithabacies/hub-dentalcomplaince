jQuery( document ).ready( function() {
    ...
    for( var key in MySubsubmenu ) {
        ...
        obj.hover(
            function() {
                ...
                jQuery( this ).parents( 'li' ).addClass( 'wpc_subsubmenu_hover' );
            },
            function() {
                if ( !color_hover ) {
                    color_hover = jQuery( this ).css( 'color' ) ;
                }
                jQuery( this ).parents( 'li' ).removeClass( 'wpc_subsubmenu_hover' );
            }
        );
    ...
    jQuery( 'ul.subsubmenu li a' ).hover(
        function() {
            ...
            jQuery( this ).parents( 'ul' ).parents( 'li' ).addClass( 'wpc_subsubmenu_hover' );
        },
        function() {
            jQuery( this ).css( 'color', color );
            jQuery( this ).parents( 'ul' ).parents( 'li' ).removeClass( 'wpc_subsubmenu_hover' );
        }
    );
});