    ...
    $.infinitescroll.prototype = {
        ...
        _create: function infscr_create(options, callback) {
            ...
            if(opts.pixelsFromNavToBottom === undefined) {
                ...
                opts.pixelsFromNavToBottom = this.element.height();
        ...
        _nearbottom: function infscr_nearbottom() {
            ...
            pixelsFromWindowBottomToBottom = 0 + this.element.find(opts.itemSelector + ':last').position().top - (opts.binder.scrollTop());
        ...
        // refresh scroll
        refresh: function infscr_refresh() {
